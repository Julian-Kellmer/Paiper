        ...
        >
          <DialogHeader>
            ...
            <DialogDescription className="dark:text-gray-400">
              Visualiza los regalos que has enviado y recibido
            </DialogDescription>
          </DialogHeader>
            ...
            >
              {receivedGifts.length > 0 ? (
                <div className="space-y-3">
                  {receivedGifts.map((gift, index) => (
                    ...
                    >
                      ...
                      <div className="flex-1" id={`kw2t1y_${index}`}>
                        <div
                          ...
                          <div id={`cpwqk5_${index}`}>
                            ...
                            >
                              ...
                              >
                                ...
                                <AvatarFallback id={`ezroy1_${index}`}>
                ...
                <div className="text-center py-8">
                  ...
                  >
                    No has recibido ningún regalo aún
                  </p>
                </div>
              )}
            </TabsContent>
              ...
              {sentGifts.length > 0 ? (
                <div className="space-y-3">
                  {sentGifts.map((gift, index) => (
                    ...
                    >
                      ...
                      <div className="flex-1" id={`xoa7k3_${index}`}>
                        <div
                          className="flex justify-between items-start"
                          id={`8k2xt0_${index}`}
                        >
                              ...
                              {gift.recipient.name ? (
                                <>
                                  ...
                                  >
                                    ...
                                    <AvatarFallback id={`rrxu8n_${index}`}>
                                ...
                                <p
                                  ...
                                  id={`aolk68_${index}`}
                                >
                                  Para: Mesa {gift.recipient.table}
                                </p>
                              )}
                            </div>
                          </div>
                ...
                <div className="text-center py-8">
                  ...
                  <p
                    className="text-muted-foreground dark:text-gray-400"
                  >
                    No has enviado ningún regalo aún
                  </p>
                </div>
              )}
            </TabsContent>
