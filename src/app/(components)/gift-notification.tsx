...
export function GiftNotification({ gift, onClose }: GiftNotificationProps) {
  ...
  const giftData = gift || defaultGift;
    ...
    <Sheet defaultOpen onOpenChange={onClose}>
      ...
      >
        <SheetHeader className="text-left">
          <SheetTitle
            className="flex items-center text-xl dark:text-white"
          >
            <GiftIcon className="h-5 w-5 mr-2 text-purple-500" />
            ¡Has recibido un regalo!
          </SheetTitle>
          <SheetDescription className="dark:text-gray-400">
            Alguien te ha enviado una bebida. Muestra el código QR en la barra
            para canjearla.
          </SheetDescription>
        </SheetHeader>
        ...
        {!showQR ? (
          <div className="py-6 space-y-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                <Avatar>
                  <AvatarImage
                    src={giftData.sender.avatar}
                    alt={giftData.sender.name}
                  />

                  <AvatarFallback>
                    {giftData.sender.name.charAt(0)}
                  </AvatarFallback>
                </Avatar>
                <div>
            ...
            >
              <div className="flex items-start space-x-4">
                ...
                >
                  <img
                    src={giftData.drink.image}
                    alt={giftData.drink.name}
              ...
              {giftData.message && (
                <div
                  className="mt-4 p-3 bg-background dark:bg-gray-900 rounded-md text-sm italic"
                >
                  "{giftData.message}"
                </div>
              )}
            ...
            <div className="space-y-2 text-center">
              <p
                className="text-sm text-muted-foreground dark:text-gray-400"
              >
                ID del regalo: {giftData.id}
              </p>
              <p
                className="text-sm text-muted-foreground dark:text-gray-400"
              >
                Para canjear tu regalo, haz clic en el botón de abajo y muestra
                el código QR al bartender.
              </p>
            </div>
          </div>
        ) : (
          <div className="py-6 space-y-6 text-center">
            <div
              className="bg-white p-4 rounded-lg mx-auto max-w-[250px]"
            >
            ...
            <div>
              ...
              <p
                className="text-sm text-muted-foreground dark:text-gray-400 mt-1"
              >
                ID: {giftData.id}
              </p>
            </div>
            ...
            <div
              className="bg-muted/30 p-4 rounded-lg dark:bg-gray-800/30 text-left"
            >
              <p
              ...
              <ol
                className="text-sm text-muted-foreground dark:text-gray-400 space-y-2 list-decimal pl-4"
              >
                <li>Muestra este código QR al bartender</li>
                <li>
                  El bartender escaneará el código para validar tu regalo
                </li>
