...
export function GiftService({ isOpen, onClose }: GiftServiceProps) {
  ...
  const tables = [
    { id: "VIP 3", name: "VIP 3", capacity: 6, status: "occupied" },
    { id: "VIP 5", name: "VIP 5", capacity: 8, status: "occupied" },
    { id: "VIP 8", name: "VIP 8", capacity: 10, status: "occupied" },
    { id: "VIP 12", name: "VIP 12", capacity: 6, status: "occupied" },
    { id: "VIP 15", name: "VIP 15", capacity: 8, status: "occupied" },
  ];
  ...
  const renderStepOne = () => (
    <div className="space-y-6">
      ...
      >
        <TabsList
          className="grid w-full grid-cols-2 dark:bg-gray-800"
        >
          <TabsTrigger
            value="guests"
        ...
        >
          {filteredGuests.length > 0 ? (
                ...
                >
                  ...
                  >
                    <Avatar id={`guest-avatar-${guest.id}`}>
                      ...
                      <AvatarFallback id={`avatar-fallback-${guest.id}`}>
                        {guest.name.charAt(0)}
                      </AvatarFallback>
                    </Avatar>
            ...
            <div className="text-center py-8">
              <UserIcon
                className="h-12 w-12 mx-auto text-muted-foreground dark:text-gray-500 mb-2"
              />
  ...
  const renderStepTwo = () => (
    <div className="space-y-6">
      <div
        className="bg-muted/30 p-4 rounded-lg dark:bg-gray-800/30"
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          {filteredDrinks.map((drink) => (
            ...
            >
              ...
              <div className="flex-1" id={`drink-info-${drink.id}`}>
                <div
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-between items-start">
            <div className="space-y-1">
              ...
              <div className="flex items-center">
                <div
                  className="h-10 w-10 rounded-md overflow-hidden mr-2"
                >
                  <img
  ...
  const renderStepFour = () => (
    <div className="text-center space-y-6 py-4">
      <div
        className="h-20 w-20 rounded-full bg-green-100 dark:bg-green-900/20 flex items-center justify-center mx-auto"
      >
        <CheckIcon
      ...
      <div className="space-y-2">
        ...
        <p
          className="text-muted-foreground dark:text-gray-400 max-w-md mx-auto"
        >
          {selectedGuest
            ? `${selectedGuest.name} ha recibido una notificación con los detalles del regalo.`
            : `La Mesa ${selectedTable} ha recibido una notificación con los detalles del regalo.`}
        </p>
      </div>

      <div
        className="bg-muted/30 p-4 rounded-lg dark:bg-gray-800/30 max-w-md mx-auto text-left"
      >
        <div
        ...
        >
          ...
          <div className="space-y-2">
            ...
            >
              Para:{" "}
              {selectedGuest ? selectedGuest.name : `Mesa ${selectedTable}`}
            </p>
            {message && (
              <div
                className="bg-background dark:bg-gray-900 p-3 rounded-md text-sm italic"
              >
                "{message}"
              </div>
            )}
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent
        className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto dark:bg-gray-900 dark:border-gray-800"
      >
        <DialogHeader>
          <DialogTitle
        ...
        <DialogFooter
          className="flex flex-col-reverse sm:flex-row sm:justify-between sm:space-x-2 gap-2"
        >
          {step < 4 ? (
            <>
              <Button
              ...
              <Button
                ...
                disabled={
                  (step === 1 && !selectedGuest && !selectedTable) ||
