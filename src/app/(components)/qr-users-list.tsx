				...
				{topUsers.map((user, index) => (
					<div
						...
						<Avatar
							...
							<AvatarFallback id={`top-user-avatar-fallback-${user.id}`}>{user.name.charAt(0)}</AvatarFallback>
						</Avatar>
						<div
							className='flex-1'
