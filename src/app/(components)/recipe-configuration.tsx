				...
				{filteredRecipes.map((recipe) => (
					<div
						...
						{recipe.available !== null ? (
							<Badge className={cn('mb-3', recipe.available > 0 ? 'bg-green-50 text-green-700 border-green-200' : 'bg-red-50 text-red-700 border-red-200')}>
						...
						{recipe.available === null && <div className='mt-3 p-2 bg-red-50 text-red-700 text-sm rounded border border-red-200'>Falta stock de ingredientes</div>}
					</div>
				))}
			</div>
