...
import { CreditCard, DollarSign, User, ShoppingBag, Check, ArrowLeft, Wallet, CreditCardIcon } from 'lucide-react';
...
export default function Checkout({ cartItems, selectedUser, onOrderComplete, isFromTable, tableNumber }: CheckoutProps) {
						...
						<Card className='mt-6'>
							...
							<CardContent>
								{selectedUser ? (
									...
									<div className='text-center py-4 text-muted-foreground'>Anonymous Customer</div>
								)}
							</CardContent>
						</Card>
					</div>
							...
							<CardContent>
								<RadioGroup
									...
									<div>
										...
										{paymentMethod === 'mercadopago' && <div className='mt-3 ml-6 text-sm text-muted-foreground'>Pay securely with Mercado Pago</div>}
									</div>
									...
									<div>
										...
										{paymentMethod === 'cash' && <div className='mt-3 ml-6 text-sm text-muted-foreground'>Pay with cash at the counter</div>}
									</div>
									...
									<div>
										...
										{paymentMethod === 'cashless' && <div className='mt-3 ml-6 text-sm text-muted-foreground'>Pay with your cashless wristband</div>}
									</div>
								</RadioGroup>
							</CardContent>
							<CardFooter className='flex flex-col gap-2'>
								{error && <div className='w-full p-2 text-sm text-red-500 bg-red-50 rounded-md'>{error}</div>}
								<Button
									className='w-full'
									size='lg'
