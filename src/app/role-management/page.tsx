...
export default function RoleManagement() {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <DialogContent
          className="sm:max-w-[700px] max-h-[90vh] overflow-y-auto dark:bg-gray-900 dark:border-gray-800"
        >
          {selectedUser && (
            <>
              <DialogHeader>
                    ...
                    <div className="space-y-2">
                      ...
                      <Select defaultValue={selectedUser.type}>
                        ...
                        >
                          ...
                          <SelectItem value="Cliente VIP">
                            Cliente VIP
                          </SelectItem>
                          <SelectItem value="Equipo">
                            Equipo
                          </SelectItem>
                          <SelectItem value="Equipo Publicas">
                            Equipo Publicas
                          </SelectItem>
                        </SelectContent>
                      </Select>
                  ...
                  selectedUser.transactions.length > 0 ? (
                    <div className="space-y-4">
                      ...
                      >
                        <table className="w-full">
                          <thead
                            className="bg-muted/50 dark:bg-gray-800 text-left"
                          >
                            <tr>
                              <th
                                className="p-3 font-medium text-muted-foreground dark:text-gray-400"
                              >
                                ID
                              </th>
                              <th
